...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('backoffice/images/logo/favicon.ico') }}" type="image/x-icon" />
    <link rel="shortcut icon" href="{{ asset('backoffice/images/logo/favicon.png') }}" type="image/png" />
